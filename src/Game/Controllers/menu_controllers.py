...
from src.Game.AI.AI_main import AI_MODE_CLASSIC, AI_MODE_SELF_LEARNING
...
class Menu:
    ...
    def __handle_lmb_up(self):
        ...
        if self.MenuDrawer.opposite_chess_button.collidepoint(mouse_position) and self.MenuDrawer.in_PVP_setup:
            ...
            click_sound.play_sound()
        elif self.MenuDrawer.classic_ai_button.collidepoint(mouse_position) and self.MenuDrawer.in_AI_setup:
            game.against_ai(ai_mode=AI_MODE_CLASSIC)
        elif self.MenuDrawer.self_learning_ai_button.collidepoint(mouse_position) and self.MenuDrawer.in_AI_setup:
            game.against_ai(ai_mode=AI_MODE_SELF_LEARNING, fallback_to_classic=True)
            ...
            self.MenuDrawer.set_page_in_AI_setup(False)
            click_sound.play_sound()
